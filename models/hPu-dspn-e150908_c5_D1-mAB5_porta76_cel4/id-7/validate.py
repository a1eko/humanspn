...
def main(args):
    ...
    for model in rej_models:
        ax1.plot(model['iv_curve']['stim'], model['iv_curve']['volt'], color='grey') #, lw=0.5, alpha=0.25)
        ax2.plot(model['id_curve']['stim'], model['id_curve']['freq'], color='grey') #, lw=0.5, alpha=0.25)
